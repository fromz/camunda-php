...
use Camunda\Client;
use Exception;
use Camunda\Request\ProcessInstanceRequest;
use Camunda\Request\VariableRequest;
use Camunda\Response\Activity;
...
class ProcessInstanceService
{
   ...
   * @throws \Exception
   * @return \Camunda\Response\ProcessInstance $this requested process instance
   */
    public function getInstance($id)
    {
        $processInstance = new ProcessInstance();
        $this->client->setRequestUrl('/process-instance/'.$id);
    ...
    {
        $this->client->setRequestUrl('/process-instance/');
    ...
    {
        $this->client->setRequestUrl('/process-instance/count/');
        $this->client->setRequestData($request);
        if ($isPostRequest == true) {
            $this->client->setRequestMethod('POST');
        } else {
    ...
    public function getProcessVariable($id, $variableId)
    {
        ...
        $this->client->setRequestUrl('/process-instance/'.$id.'/variables/'.$variableId);
        $this->client->setRequestData(null);
        $this->client->setRequestMethod('GET');
    ...
    {
        $this->client->setRequestUrl('/process-instance/'.$id.'/variables');
        $this->client->setRequestData(null);
        $this->client->setRequestMethod('GET');
    ...
    {
        $this->client->setRequestUrl('/process-instance/'. $id . '/activity-instances');
        $this->client->setRequestData($request);
        $this->client->setRequestMethod('GET');
    ...
    {
        $this->client->setRequestUrl('/process-instance/'.$id.'/suspended');
        $this->client->setRequestData($request);
        $this->client->setRequestMethod('PUT');
